...
export const updateUserPassword = (userId,data) => {
    return (dispatch) => {
        return axios
            .post(`${API_URL}/user/update/password/${userId}`, data, { headers:  AuthService.authHeader() })
            .then(() => {
...
export const updateUserFirstName = (userId,data) => {
    return (dispatch) => {
        return axios
            .post(`${API_URL}/user/update/firstname/${userId}`, data, { headers:  AuthService.authHeader() })
            .then(() => {
...
export const updateUserLastName = (userId,data) => {
    return (dispatch) => {
        return axios
            .post(`${API_URL}/user/update/lastname/${userId}`, data, { headers:  AuthService.authHeader() })
            .then(() => {
...
export const updateUserEmail = (userId,data) => {
    return (dispatch) => {
        return axios
            .post(`${API_URL}/user/update/email/${userId}`, data, { headers:  AuthService.authHeader() })
            .then(() => {
...
export const updateUserPseudo = (userId,data) => {
    return (dispatch) => {
        return axios
            .post(`${API_URL}/user/update/pseudo/${userId}`, data, { headers:  AuthService.authHeader() })
            .then(() => {
